...
export default function TripLists() {
  ...
  const getStatusInfo = (status: string) => {
    switch (status) {
      case "SCHEDULED":
        return { text: "Ready to Board", color: "text-green-600", bgColor: "bg-green-100" }
      case "BOARDING":
        return { text: "Now Boarding", color: "text-blue-600", bgColor: "bg-blue-100" }
      default:
      ...
      <div className="space-y-4 max-w-xs mx-auto">
        {loading ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-500 text-sm">Loading today&#39;s trips...</p>
          </div>
        ) : trips.length === 0 ? (
          <div className="text-center py-8">
          ...
          trips.map((trip) => {
            ...
            return (
              <Card key={trip.id} className="bg-white shadow-lg rounded-2xl border-0 overflow-hidden p-0">
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        ...
                        <h2 className="text-lg font-bold text-gray-900">{trip.route}</h2>
                      </div>
                    ...
                    <Button
                      ...
                      className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white h-10 text-sm font-medium flex items-center justify-center gap-2 transition-colors"
                    >
