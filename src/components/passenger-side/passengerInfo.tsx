//VANTay-2.0\src\components\passenger-side\passengerInfo.tsx
...
export default function PassengerInfo() {
    ...
    try {
      const response = await fetch("/api/passenger/tickets", {
        ...
        body: JSON.stringify({
          ...
          passengerType: formData.classification
            .toUpperCase()
            .replace(" ", "_"),
        }),
      })
  ...
  const isFormValid = () => {
    ...
    return requiredFields.every(
      (field) => formData[field as keyof PassengerData].trim() !== ""
    )
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b via-gray-100 from-indigo-300 flex items-center justify-center">
        <div className="text-center">
          ...
          <Button onClick={() => router.push("/passenger/trips")}>
            Back to Trips
          </Button>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b via-gray-100 from-indigo-300 px-4 py-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6 max-w-sm mx-auto">
        ...
        {/* Age */}
        <div className="space-y-2">
          <Label htmlFor="age" className="text-gray-700 font-bold">Age *</Label>
          <Input
            id="age"
            type="number"
            value={formData.age}
        ...
        {/* Emergency Contact */}
        <div className="space-y-2">
          <Label htmlFor="emergencyContact" className="text-gray-700 font-bold">Emergency Contact</Label>
          <Input
            id="emergencyContact"
            type="tel"
        ...
        {/* Classification */}
        <div className="space-y-2">
          <Label htmlFor="classification" className="text-gray-700 font-bold">Classification *</Label>
          <Select
      ...
      {/* Debug Info */}
      <div className="max-w-sm mx-auto mt-8 p-3 bg-gray-100 rounded text-xs text-gray-600">
        <p>Debug Info:</p>
        <p>Trip ID: {tripId}</p>
        <p>Seat ID: {seatId}</p>
